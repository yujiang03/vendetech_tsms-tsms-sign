package com.vendetech.common.utils.file;

import com.vendetech.common.constant.Constants;
import com.vendetech.common.exception.file.FileNameLengthLimitExceededException;
import com.vendetech.common.exception.file.FileSizeLimitExceededException;
import com.vendetech.common.exception.file.InvalidExtensionException;
import com.vendetech.common.utils.StringUtils;
import com.vendetech.common.utils.security.Md5Utils;
import com.vendetech.framework.config.VendetechConfig;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = VendetechConfig.getProfile();
    ...
    private static String upload(String baseDir, MultipartFile file, String[] allowedExtension)
        ...
        log.debug("extractFilename fileName: " + fileName);
        log.debug("getAbsoluteFile baseDir: " + baseDir);

        File desc = getAbsoluteFile(baseDir, fileName);
        log.debug("getAbsoluteFile desc: " + desc.getAbsolutePath());
    ...
    private static String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = VendetechConfig.getProfile().length() + 1;
