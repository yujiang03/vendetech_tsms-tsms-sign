...
public class ExportExcelUtil {
	 ...
	 */
	public static XSSFWorkbook createExcelFile(Class<?> clazz, List<Map<String, Object>> objs,
	...
	private static void createFont(XSSFWorkbook workbook) {
		...
		fontStyle.setAlignment(HorizontalAlignment.CENTER);// 水平居中
	 ...
	 * @param clazz 无用
	 */
	private static void createTableRows(XSSFSheet sheet, Map<Integer, List<ExcelBean>> map,
			List<Map<String, Object>> objs, Class<?> clazz)
