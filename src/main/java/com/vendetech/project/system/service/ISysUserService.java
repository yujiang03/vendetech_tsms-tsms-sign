...
public interface ISysUserService {
	 ...
	 * @return
	 */
	public List<HashMap<String, Object>> selectByUserList(String keyword);

	public List<HashMap<String, Object>> selectUserListByKeyword(String keyword);
	...
	int updateDelFlag(CreateUserDTO createUserDTO);
